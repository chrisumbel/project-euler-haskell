...
import Euler.Problem59 (crack, strSum, splitInts, decipher, tokenize, countEnglishWords, crack, maxIndex)

main = $(defaultMainGenerator)

{- ciphertext specified for the problem. left it as an unparsed string in the spirit
    of staying close to the what the problem specifies. -}
cipherText :: String
...
{- keyspace specified by the problem -}
keyspace :: [String]
